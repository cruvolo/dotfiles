...
if has("autocmd") && !exists("autocommands_loaded")
  ...
  augroup encrypted
    ...
    autocmd BufReadPost,FileReadPost *.gpg '[,']!gpg -d --no-use-agent 2> /dev/null
    ...
    autocmd BufWritePre,FileWritePre *.gpg '[,']!gpg2 --default-recipient-self -ae
    autocmd BufWritePre,FileWritePre *.gpg redraw!
